...
public class AppAdapterFragmentThree extends RecyclerView.Adapter<AppAdapterFragmentThree.MyViewHolder> {

    List<App> mApp;

    public AppAdapterFragmentThree(List<App> AppList){
        mApp = AppList;
    }

    @NonNull
    @Override
    public AppAdapterFragmentThree.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int i) {
        View mView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fragment1,parent,false);
